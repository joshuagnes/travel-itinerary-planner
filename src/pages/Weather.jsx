...
const Weather = () => {
	...
	// Utility function to convert Unix timestamp to time (e.g., 06:30 AM)
	...
	const fetchWeather = async (city) => {
		try {
			...
			return {
				...
				sunrise: formatTime(data.sys.sunrise, data.timezone), // Sunrise time
				sunset: formatTime(data.sys.sunset, data.timezone), // Sunset time
			};
		} catch (error) {
		...
		<div className="app">
			<div className="search-bar">
				<input
					...
					onKeyPress={(e) => e.key === 'Enter' && search(inputValue)}
				/>
				{inputValue && (
					<img
						src={clear_icon}
